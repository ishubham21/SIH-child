    ...
    <main>
      ...
      <div className={style.gamegrid}>
        ...
        <Link to={"DunkShot"} className={style.game}>
          <img src={require("../../assets/gamecovers/DunkShot.png")} />
          <h3>Dunk Shot</h3>
        </Link>
        <Link to={"SlitSight"} className={style.game}>
          <img src={require("../../assets/gamecovers/SlitSight.png")} />
          <h3>Slit Sight</h3>
        </Link>
        <Link to={"WordFinder"} className={style.game}>
          <img src={require("../../assets/gamecovers/WordFinder.png")} />
          <h3>Word Finder</h3>
        </Link>
        <Link to={"TicTacToe"} className={style.game}>
          <img src={require("../../assets/gamecovers/TicTacToe.png")} />
          <h3>Tic Tac Toe</h3>
        </Link>
      </div>
    </main>
